...
type ConfigConstant struct {
	...
	GroupID   string `json:"group_id" gorm:"type:varchar(50);primaryKey;comment:ไอดีกลุ่มค่าคงที่;"`
	...
	RefValue2 string `json:"ref_value2" gorm:"type:varchar(100);comment:ค่าอ้างอิง 2;"`
